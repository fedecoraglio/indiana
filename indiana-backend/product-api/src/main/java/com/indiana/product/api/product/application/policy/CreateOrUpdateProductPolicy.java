package com.indiana.product.api.product.application.policy;

import static com.indiana.product.api.product.application.exception.ProductException.ProductExceptionType.PRODUCT_CANNOT_BE_NULL;
import static com.indiana.product.api.product.application.exception.ProductException.ProductExceptionType.PRODUCT_NAME_CANNOT_BE_NULL_OR_EMPTY;
...
public class CreateOrUpdateProductPolicy {
  ...
  public void check(final ProductDto productDto) throws ProductException {
    if (productDto == null) {
      throw new ProductException(PRODUCT_CANNOT_BE_NULL);
    }
    if (productDto.getName() == null || productDto.getName().isEmpty()) {
      throw new ProductException(PRODUCT_NAME_CANNOT_BE_NULL_OR_EMPTY);
    }
