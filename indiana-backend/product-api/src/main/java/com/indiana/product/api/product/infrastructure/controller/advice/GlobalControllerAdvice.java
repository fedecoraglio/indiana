package com.indiana.product.api.product.infrastructure.controller.advice;
...
import com.indiana.product.api.product.infrastructure.controller.response.ErrorResponse;
...
public class GlobalControllerAdvice {
  ...
  public ResponseEntity<ErrorResponse> handleArgumentNotValidExceptions(
    ...
    return handleProductInfraException(
        new ProductInfraException(new ProductException(PRODUCT_UNEXPECTED_ERROR)));
  }
