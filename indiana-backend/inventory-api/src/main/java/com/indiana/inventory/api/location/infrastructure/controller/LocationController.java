package com.indiana.inventory.api.location.infrastructure.controller;

import com.indiana.inventory.api.location.application.dto.LocationDto;
import com.indiana.inventory.api.location.application.sort.LocationSortBy;
import com.indiana.inventory.api.location.infrastructure.controller.convert.LocationRequestConverter;
import com.indiana.inventory.api.location.infrastructure.controller.request.LocationRequest;
import com.indiana.inventory.api.location.infrastructure.controller.response.ListLocationResponse;
import com.indiana.inventory.api.location.infrastructure.service.LocationService;
...
public class LocationController {
  ...
  @GetMapping()
  public ResponseEntity<ListLocationResponse> search(@Param("query") final String query,
